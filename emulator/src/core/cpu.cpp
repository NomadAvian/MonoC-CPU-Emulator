...
bool CPU::Execute(DecodedInstruction instr) {
    switch (instr.type) {
    case Type::kR: return ExecuteRType(instr);
    case Type::kI: return ExecuteIType(instr);
    case Type::kS: return ExecuteSType(instr);
    case Type::kB: return ExecuteBType(instr);
    case Type::kU: return ExecuteUType(instr);
    case Type::kJ: return ExecuteJType(instr);
    default:
    return false;
    }
}
