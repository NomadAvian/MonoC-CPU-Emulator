...
```bash
./start_monoc.sh # builds and runs the web app on port :5173
```
...
1. [RISCV Manual](https://docs.riscv.org/reference/isa/_attachments/riscv-unprivileged.pdf)
2. [RISCV Assembly Programmer's Manual](https://zju-os.github.io/doc/spec/riscv-asm.pdf)
